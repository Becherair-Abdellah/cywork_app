  ...
  return (
    <aside ref={aside} className={styles}>
     ...
     <div className='flex items-center  gap-2 py-5 cursor-pointer' >
      <MdOutlineDisplaySettings size={30} className='text-primaryColor'/>
      <h1 className={h1Style}>ADMIN</h1>
     </div>
    {/* links  */}
    <div>
      <LinksUser/>
    ...
    <div className='text-gray-500 text-sm font-normal w-full text-center'>
      <span className={showAside?' text-center relative bottom-4':'hidden'}>© 2024 ,Inc. All rights reserved</span>
      <span className={showAside?' text-center hidden':'md:block hidden'}>© 2024</span>
      </div>
  </aside>
  )
}
