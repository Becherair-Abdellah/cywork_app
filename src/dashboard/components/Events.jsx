...
<h2 className='bg font-semibold absolute left-2 -top-[1rem] bg-primaryColor text-white px-1 py-1'>Add Event</h2>                <label htmlFor="text" className='text-gray-600 font-semibold flex items-center gap-2'><RiArticleLine/> Text</label>
